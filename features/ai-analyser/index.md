...
## What the AI Habit Analyser does
...
The AI Habit Analyser is not:
- Generic encouragement ("You're doing great! Keep it up!")
- A motivational chatbot
- A goal-setting assistant

It analyses your *actual* data and surfaces *real* patterns. If you skip exercise every Monday, it will tell you that. If your meditation habit is consistently stronger in the first two weeks of the month, it will show you that.

---

## Why this matters

Most habit apps show you completion percentages. That tells you *what* happened but not *why*. The AI Analyser surfaces the patterns behind the numbers, giving you something you can act on.
