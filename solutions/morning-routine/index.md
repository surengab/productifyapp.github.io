...
Attempting to build 6+ new habits simultaneously overwhelms the brain's habit-formation capacity. The routine is too different from the current baseline, so any disruption (bad night, busy week, travel) breaks the whole thing.
...
Choose one behaviour that will always happen first, that acts as the trigger for everything else. Most people use:
- Making coffee or tea
- Getting out of bed at a consistent time
- The first phone unlock of the day (though ideally you're delaying this)

### Step 2: Stack one habit onto the anchor

Pick the single morning habit that matters most to you. Attach it directly after the anchor:

> "After I make my morning coffee, I will [new habit]."

Start with the smallest possible version:
- Meditation: 2 minutes of quiet sitting
- Journaling: write one sentence
- Exercise: 5 push-ups
- Reading: read one page

### Step 3: Track it from day one

Open Productify and add the habit. Set a reminder that fires right after your anchor habit time. Track every day for 60 days before evaluating.
