...
- Measurable goals (tracking quantities, not just yes/no)
...
1. Download the app (no account required)
2. Tap "Add habit" or choose from the 50+ templates
3. Name the habit clearly: "Read 10 pages" not just "Read"
4. Set the frequency: daily, weekdays only, or specific days
5. Set a reminder: choose a time that follows your anchor habit (e.g. "after morning coffee")
6. Choose the type: binary (done/not done) or measurable (with a target number)

That's it. Keep it simple.

---

## Step 3: Do the daily check-in

This is where most people overcomplicate things. The daily check-in should take under 30 seconds:

1. Open the app when the reminder fires (or at the same time each day)
2. Tap each completed habit
3. Close the app
...
## Step 4: Handle missed days correctly

You will miss days. This is certain. The question is how you handle them.

**Rule: Never miss twice in a row.**

Missing one day has almost no statistical impact on long-term habit formation. Missing two consecutive days significantly increases the risk of abandoning the habit entirely.
...
Once a week (Sunday evening works well for most people), spend five minutes looking at your data:

- Which habits are you most consistent with?
- Which habits are you struggling with?
...
**Track in a habit tracker:**
- Daily routines you want to repeat indefinitely
- Health and fitness habits
- Mindfulness and focus habits
- Skill-building activities (language practice, reading)
...
| Quitting after a missed day | One miss ≠ failure | Apply the never-miss-twice rule |

---

## Making the check-in itself a habit

The meta-habit that supports all other habits is the daily check-in. To make it automatic:
